...
TASKS = [
    ...
    },
    {
        ...
        "correct_keywords": ["分散式帳本"],
    },
    {
        "task_id": "Q4",
        "description": "4.\t不可竄改性來源：你在學習區塊鏈特性時，經常看到「不可竄改性」這個關鍵優勢，但你開始思考：在實務上，資料真的無法被修改嗎？其背後是依靠哪些技術機制來達成？因此，你希望進一步查詢相關資訊，以了解區塊鏈如何透過技術手段（如雜湊與鏈結結構）確保資料難以被竄改。",
        "correct_keywords": ["不可竄改性"],
    },
    {
        "task_id": "Q5",
        "description": "5.\t可追溯性機制：你注意到區塊鏈被廣泛應用於需要高度透明與可追蹤的場景（如供應鏈管理）。因此，你希望理解區塊鏈是如何記錄資料歷史，並讓使用者能夠追蹤每一筆交易的來源與流向。你希望透過系統找到相關說明，以掌握其可追溯性的實現方式與應用價值。",
        "correct_keywords": ["可追溯性"],
    },
    {
        "task_id": "Q6",
